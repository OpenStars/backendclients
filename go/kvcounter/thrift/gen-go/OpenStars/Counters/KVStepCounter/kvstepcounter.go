...
// Deprecated: Use NewKVStepCounterService instead
...
func (p *KVStepCounterServiceClient) CreateGenerator(ctx context.Context, genName string) (r int32, err error) {
  var _args18 KVStepCounterServiceCreateGeneratorArgs
  _args18.GenName = genName
  var _result19 KVStepCounterServiceCreateGeneratorResult
  if err = p.c.Call(ctx, "createGenerator", &_args18, &_result19); err != nil {
    return
  }
...
func (p *KVStepCounterServiceClient) RemoveGenerator(ctx context.Context, genName string) (r int32, err error) {
  var _args20 KVStepCounterServiceRemoveGeneratorArgs
  _args20.GenName = genName
  var _result21 KVStepCounterServiceRemoveGeneratorResult
  if err = p.c.Call(ctx, "removeGenerator", &_args20, &_result21); err != nil {
    return
  }
...
func (p *KVStepCounterServiceClient) GetCurrentValue(ctx context.Context, genName string) (r int64, err error) {
  var _args22 KVStepCounterServiceGetCurrentValueArgs
  _args22.GenName = genName
  var _result23 KVStepCounterServiceGetCurrentValueResult
  if err = p.c.Call(ctx, "getCurrentValue", &_args22, &_result23); err != nil {
    return
  }
...
func (p *KVStepCounterServiceClient) GetValue(ctx context.Context, genName string) (r int64, err error) {
  var _args24 KVStepCounterServiceGetValueArgs
  _args24.GenName = genName
  var _result25 KVStepCounterServiceGetValueResult
  if err = p.c.Call(ctx, "getValue", &_args24, &_result25); err != nil {
    return
  }
...
func (p *KVStepCounterServiceClient) GetStepValue(ctx context.Context, genName string, step int64) (r int64, err error) {
  var _args26 KVStepCounterServiceGetStepValueArgs
  _args26.GenName = genName
  _args26.Step = step
  var _result27 KVStepCounterServiceGetStepValueResult
  if err = p.c.Call(ctx, "getStepValue", &_args26, &_result27); err != nil {
    return
  }
...
func NewKVStepCounterServiceProcessor(handler KVStepCounterService) *KVStepCounterServiceProcessor {
  self28 := &KVStepCounterServiceProcessor{NewTDataServiceProcessor(handler)}
  self28.AddToProcessorMap("createGenerator", &kVStepCounterServiceProcessorCreateGenerator{handler:handler})
  self28.AddToProcessorMap("removeGenerator", &kVStepCounterServiceProcessorRemoveGenerator{handler:handler})
  self28.AddToProcessorMap("getCurrentValue", &kVStepCounterServiceProcessorGetCurrentValue{handler:handler})
  self28.AddToProcessorMap("getValue", &kVStepCounterServiceProcessorGetValue{handler:handler})
  self28.AddToProcessorMap("getStepValue", &kVStepCounterServiceProcessorGetStepValue{handler:handler})
  return self28
}
