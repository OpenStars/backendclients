...
func (p TMCVideoFormat) String() string {
  switch p {
  case TMCVideoFormat_MP4_H264: return "MP4_H264"
  case TMCVideoFormat_WEBM_VP8: return "WEBM_VP8"
  case TMCVideoFormat_HLS: return "HLS"
  case TMCVideoFormat_WEBM_VP9: return "WEBM_VP9"
  case TMCVideoFormat_MP4_H265: return "MP4_H265"
  case TMCVideoFormat_DASH_VP9: return "DASH_VP9"
  case TMCVideoFormat_HLS_V2: return "HLS_V2"
  case TMCVideoFormat_HLS_WRAP_MP4: return "HLS_WRAP_MP4"
  case TMCVideoFormat_DASH_H265: return "DASH_H265"
  case TMCVideoFormat_HLS_H265: return "HLS_H265"
  case TMCVideoFormat_HLS_WRAP_MP4_SC: return "HLS_WRAP_MP4_SC"
  }
  return "<UNSET>"
}
...
func TMCVideoFormatFromString(s string) (TMCVideoFormat, error) {
  switch s {
  case "MP4_H264": return TMCVideoFormat_MP4_H264, nil 
  case "WEBM_VP8": return TMCVideoFormat_WEBM_VP8, nil 
  case "HLS": return TMCVideoFormat_HLS, nil 
  case "WEBM_VP9": return TMCVideoFormat_WEBM_VP9, nil 
  case "MP4_H265": return TMCVideoFormat_MP4_H265, nil 
  case "DASH_VP9": return TMCVideoFormat_DASH_VP9, nil 
  case "HLS_V2": return TMCVideoFormat_HLS_V2, nil 
  case "HLS_WRAP_MP4": return TMCVideoFormat_HLS_WRAP_MP4, nil 
  case "DASH_H265": return TMCVideoFormat_DASH_H265, nil 
  case "HLS_H265": return TMCVideoFormat_HLS_H265, nil 
  case "HLS_WRAP_MP4_SC": return TMCVideoFormat_HLS_WRAP_MP4_SC, nil 
  }
...
func (p TMCVideoQuality) String() string {
  switch p {
  case TMCVideoQuality_QUALITY_UNKNOWN: return "QUALITY_UNKNOWN"
  case TMCVideoQuality_QUALITY_240P: return "QUALITY_240P"
  case TMCVideoQuality_QUALITY_360P: return "QUALITY_360P"
  case TMCVideoQuality_QUALITY_480P: return "QUALITY_480P"
  case TMCVideoQuality_QUALITY_720P: return "QUALITY_720P"
  case TMCVideoQuality_QUALITY_1080P: return "QUALITY_1080P"
  case TMCVideoQuality_QUALITY_1440P: return "QUALITY_1440P"
  case TMCVideoQuality_QUALITY_2160P: return "QUALITY_2160P"
  case TMCVideoQuality_QUALITY_144P: return "QUALITY_144P"
  }
  return "<UNSET>"
}
...
func TMCVideoQualityFromString(s string) (TMCVideoQuality, error) {
  switch s {
  case "QUALITY_UNKNOWN": return TMCVideoQuality_QUALITY_UNKNOWN, nil 
  case "QUALITY_240P": return TMCVideoQuality_QUALITY_240P, nil 
  case "QUALITY_360P": return TMCVideoQuality_QUALITY_360P, nil 
  case "QUALITY_480P": return TMCVideoQuality_QUALITY_480P, nil 
  case "QUALITY_720P": return TMCVideoQuality_QUALITY_720P, nil 
  case "QUALITY_1080P": return TMCVideoQuality_QUALITY_1080P, nil 
  case "QUALITY_1440P": return TMCVideoQuality_QUALITY_1440P, nil 
  case "QUALITY_2160P": return TMCVideoQuality_QUALITY_2160P, nil 
  case "QUALITY_144P": return TMCVideoQuality_QUALITY_144P, nil 
  }
...
func (p TMCImageQuality) String() string {
  switch p {
  case TMCImageQuality_QUALITY_UNKNOWN: return "QUALITY_UNKNOWN"
  case TMCImageQuality_QUALITY_240P: return "QUALITY_240P"
  case TMCImageQuality_QUALITY_360P: return "QUALITY_360P"
  case TMCImageQuality_QUALITY_480P: return "QUALITY_480P"
  case TMCImageQuality_QUALITY_720P: return "QUALITY_720P"
  case TMCImageQuality_QUALITY_144P: return "QUALITY_144P"
  }
  return "<UNSET>"
}
...
func TMCImageQualityFromString(s string) (TMCImageQuality, error) {
  switch s {
  case "QUALITY_UNKNOWN": return TMCImageQuality_QUALITY_UNKNOWN, nil 
  case "QUALITY_240P": return TMCImageQuality_QUALITY_240P, nil 
  case "QUALITY_360P": return TMCImageQuality_QUALITY_360P, nil 
  case "QUALITY_480P": return TMCImageQuality_QUALITY_480P, nil 
  case "QUALITY_720P": return TMCImageQuality_QUALITY_720P, nil 
  case "QUALITY_144P": return TMCImageQuality_QUALITY_144P, nil 
  }
...
func (p TMCGifQuality) String() string {
  switch p {
  case TMCGifQuality_QUALITY_UNKNOWN: return "QUALITY_UNKNOWN"
  case TMCGifQuality_QUALITY_240P: return "QUALITY_240P"
  case TMCGifQuality_QUALITY_360P: return "QUALITY_360P"
  case TMCGifQuality_QUALITY_480P: return "QUALITY_480P"
  case TMCGifQuality_QUALITY_720P: return "QUALITY_720P"
  case TMCGifQuality_QUALITY_144P: return "QUALITY_144P"
  }
  return "<UNSET>"
}
...
func TMCGifQualityFromString(s string) (TMCGifQuality, error) {
  switch s {
  case "QUALITY_UNKNOWN": return TMCGifQuality_QUALITY_UNKNOWN, nil 
  case "QUALITY_240P": return TMCGifQuality_QUALITY_240P, nil 
  case "QUALITY_360P": return TMCGifQuality_QUALITY_360P, nil 
  case "QUALITY_480P": return TMCGifQuality_QUALITY_480P, nil 
  case "QUALITY_720P": return TMCGifQuality_QUALITY_720P, nil 
  case "QUALITY_144P": return TMCGifQuality_QUALITY_144P, nil 
  }
...
func (p TMCAudioQuality) String() string {
  switch p {
  case TMCAudioQuality_QUALITY_UNKNOWN: return "QUALITY_UNKNOWN"
  case TMCAudioQuality_QUALITY_32K: return "QUALITY_32K"
  case TMCAudioQuality_QUALITY_64K: return "QUALITY_64K"
  case TMCAudioQuality_QUALITY_96K: return "QUALITY_96K"
  case TMCAudioQuality_QUALITY_128K: return "QUALITY_128K"
  case TMCAudioQuality_QUALITY_256K: return "QUALITY_256K"
  case TMCAudioQuality_QUALITY_320K: return "QUALITY_320K"
  case TMCAudioQuality_QUALITY_500K: return "QUALITY_500K"
  case TMCAudioQuality_QUALITY_LOSSLESS: return "QUALITY_LOSSLESS"
  }
  return "<UNSET>"
}
...
func TMCAudioQualityFromString(s string) (TMCAudioQuality, error) {
  switch s {
  case "QUALITY_UNKNOWN": return TMCAudioQuality_QUALITY_UNKNOWN, nil 
  case "QUALITY_32K": return TMCAudioQuality_QUALITY_32K, nil 
  case "QUALITY_64K": return TMCAudioQuality_QUALITY_64K, nil 
  case "QUALITY_96K": return TMCAudioQuality_QUALITY_96K, nil 
  case "QUALITY_128K": return TMCAudioQuality_QUALITY_128K, nil 
  case "QUALITY_256K": return TMCAudioQuality_QUALITY_256K, nil 
  case "QUALITY_320K": return TMCAudioQuality_QUALITY_320K, nil 
  case "QUALITY_500K": return TMCAudioQuality_QUALITY_500K, nil 
  case "QUALITY_LOSSLESS": return TMCAudioQuality_QUALITY_LOSSLESS, nil 
  }
...
func (p TMCMediaStatus) String() string {
  switch p {
  case TMCMediaStatus_QUEUING: return "QUEUING"
  case TMCMediaStatus_PROCESSING: return "PROCESSING"
  case TMCMediaStatus_DONE: return "DONE"
  case TMCMediaStatus_DONE_WITH_ERROR: return "DONE_WITH_ERROR"
  case TMCMediaStatus_DOWNLOADING: return "DOWNLOADING"
  case TMCMediaStatus_INPUT_FILE_INVALID: return "INPUT_FILE_INVALID"
  case TMCMediaStatus_ID_ZEN_ERROR: return "ID_ZEN_ERROR"
  case TMCMediaStatus_PROCESS_ERROR: return "PROCESS_ERROR"
  case TMCMediaStatus_DATABASE_ERROR: return "DATABASE_ERROR"
  case TMCMediaStatus_UNSUPPORTED_FORMAT: return "UNSUPPORTED_FORMAT"
  case TMCMediaStatus_UNSUPPORTED_QUALITY: return "UNSUPPORTED_QUALITY"
  case TMCMediaStatus_QLT_HIGHER_THAN_ORIGIN: return "QLT_HIGHER_THAN_ORIGIN"
  case TMCMediaStatus_DOWNLOAD_INTERNAL_FAIL: return "DOWNLOAD_INTERNAL_FAIL"
  case TMCMediaStatus_DOWNLOAD_EXTERNAL_FAIL: return "DOWNLOAD_EXTERNAL_FAIL"
  case TMCMediaStatus_NETWORK_ERROR: return "NETWORK_ERROR"
  case TMCMediaStatus_DELETED: return "DELETED"
  case TMCMediaStatus_INPUT_QLT_LOW: return "INPUT_QLT_LOW"
  }
  return "<UNSET>"
}
...
func TMCMediaStatusFromString(s string) (TMCMediaStatus, error) {
  switch s {
  case "QUEUING": return TMCMediaStatus_QUEUING, nil 
  case "PROCESSING": return TMCMediaStatus_PROCESSING, nil 
  case "DONE": return TMCMediaStatus_DONE, nil 
  case "DONE_WITH_ERROR": return TMCMediaStatus_DONE_WITH_ERROR, nil 
  case "DOWNLOADING": return TMCMediaStatus_DOWNLOADING, nil 
  case "INPUT_FILE_INVALID": return TMCMediaStatus_INPUT_FILE_INVALID, nil 
  case "ID_ZEN_ERROR": return TMCMediaStatus_ID_ZEN_ERROR, nil 
  case "PROCESS_ERROR": return TMCMediaStatus_PROCESS_ERROR, nil 
  case "DATABASE_ERROR": return TMCMediaStatus_DATABASE_ERROR, nil 
  case "UNSUPPORTED_FORMAT": return TMCMediaStatus_UNSUPPORTED_FORMAT, nil 
  case "UNSUPPORTED_QUALITY": return TMCMediaStatus_UNSUPPORTED_QUALITY, nil 
  case "QLT_HIGHER_THAN_ORIGIN": return TMCMediaStatus_QLT_HIGHER_THAN_ORIGIN, nil 
  case "DOWNLOAD_INTERNAL_FAIL": return TMCMediaStatus_DOWNLOAD_INTERNAL_FAIL, nil 
  case "DOWNLOAD_EXTERNAL_FAIL": return TMCMediaStatus_DOWNLOAD_EXTERNAL_FAIL, nil 
  case "NETWORK_ERROR": return TMCMediaStatus_NETWORK_ERROR, nil 
  case "DELETED": return TMCMediaStatus_DELETED, nil 
  case "INPUT_QLT_LOW": return TMCMediaStatus_INPUT_QLT_LOW, nil 
  }
...
func (p TMCSourceType) String() string {
  switch p {
  case TMCSourceType_FTP: return "FTP"
  case TMCSourceType_HTTP: return "HTTP"
  case TMCSourceType_LOCAL: return "LOCAL"
  }
  return "<UNSET>"
}
...
func TMCSourceTypeFromString(s string) (TMCSourceType, error) {
  switch s {
  case "FTP": return TMCSourceType_FTP, nil 
  case "HTTP": return TMCSourceType_HTTP, nil 
  case "LOCAL": return TMCSourceType_LOCAL, nil 
  }
