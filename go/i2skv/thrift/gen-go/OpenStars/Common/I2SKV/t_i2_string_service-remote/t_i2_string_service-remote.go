...
func main() {
  ...
  client := I2SKV.NewTI2StringServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "putData":
    ...
    argvalue1 := I2SKV.NewTStringValue()
