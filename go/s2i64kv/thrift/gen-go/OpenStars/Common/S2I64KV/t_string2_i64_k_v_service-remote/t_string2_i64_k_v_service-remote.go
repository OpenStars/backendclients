...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  TErrorCode putData(TKey key, TI64Value data)")
  fmt.Fprintln(os.Stderr, "  TCasResultType casData(TKey key, TCasValue casVal)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := S2I64KV.NewTString2I64KVServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "putData":
    ...
    argvalue1 := S2I64KV.NewTI64Value()
  ...
  case "casData":
    if flag.NArg() - 1 != 2 {
      fmt.Fprintln(os.Stderr, "CasData requires 2 args")
      flag.Usage()
    }
    argvalue0 := flag.Arg(1)
    value0 := S2I64KV.TKey(argvalue0)
    ...
    argvalue1 := S2I64KV.NewTCasValue()
    ...
    value1 := argvalue1
    fmt.Print(client.CasData(context.Background(), value0, value1))
    fmt.Print("\n")
    break
  case "":
    Usage()
