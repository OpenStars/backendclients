...
func (p TErrorCode) String() string {
  ...
  case TErrorCode_ECasFailed: return "ECasFailed"
  }
  return "<UNSET>"
}
...
func TErrorCodeFromString(s string) (TErrorCode, error) {
  ...
  case "ECasFailed": return TErrorCode_ECasFailed, nil 
  }
...
func (p *TDataServiceClient) CasData(ctx context.Context, key TKey, casVal *TCasValue) (r *TCasResultType, err error) {
  ...
  if err = p.c.Call(ctx, "casData", &_args9, &_result10); err != nil {
    return
  }
...
// Deprecated: Use NewTString2I64KVService instead
