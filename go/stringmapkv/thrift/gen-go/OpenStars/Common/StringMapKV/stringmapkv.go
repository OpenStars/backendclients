...
type TDataService interface {
  ...
  //  - Key
  //  - Data
  PutData(ctx context.Context, key TKey, data *TStringValue) (r TErrorCode, err error)
  // Parameters:
  //  - Key
  DeleteData(ctx context.Context, key TKey) (r TErrorCode, err error)
}
...
// Parameters:
//  - Key
func (p *TDataServiceClient) DeleteData(ctx context.Context, key TKey) (r TErrorCode, err error) {
  var _args9 TDataServiceDeleteDataArgs
  _args9.Key = key
  var _result10 TDataServiceDeleteDataResult
  if err = p.c.Call(ctx, "deleteData", &_args9, &_result10); err != nil {
    return
  }
...
func NewTDataServiceProcessor(handler TDataService) *TDataServiceProcessor {
  ...
  self11.processorMap["deleteData"] = &tDataServiceProcessorDeleteData{handler:handler}
return self11
}
...
type tDataServiceProcessorDeleteData struct {
  handler TDataService
}

func (p *tDataServiceProcessorDeleteData) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := TDataServiceDeleteDataArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
  ...
  iprot.ReadMessageEnd()
  result := TDataServiceDeleteDataResult{}
var retval TErrorCode
  var err2 error
  if retval, err2 = p.handler.DeleteData(ctx, args.Key); err2 != nil {
...
type TDataServicePutDataArgs struct {
  Key TKey `thrift:"key,1" db:"key" json:"key"`
  Data *TStringValue `thrift:"data,2" db:"data" json:"data"`
}
...
// Attributes:
//  - Key
type TDataServiceDeleteDataArgs struct {
  Key TKey `thrift:"key,1" db:"key" json:"key"`
}

func NewTDataServiceDeleteDataArgs() *TDataServiceDeleteDataArgs {
  return &TDataServiceDeleteDataArgs{}
}


func (p *TDataServiceDeleteDataArgs) GetKey() TKey {
  return p.Key
}
func (p *TDataServiceDeleteDataArgs) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *TDataServiceDeleteDataArgs)  ReadField1(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  temp := TKey(v)
...
func (p *TDataServiceDeleteDataArgs) Write(oprot thrift.TProtocol) error {
...
func (p *TDataServiceDeleteDataArgs) writeField1(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("key", thrift.STRING, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:key: ", p), err) }
  if err := oprot.WriteString(string(p.Key)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.key (1) field write error: ", p), err) }
...
func (p *TDataServiceDeleteDataArgs) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("TDataServiceDeleteDataArgs(%+v)", *p)
}

// Attributes:
//  - Success
type TDataServiceDeleteDataResult struct {
  Success *TErrorCode `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewTDataServiceDeleteDataResult() *TDataServiceDeleteDataResult {
  return &TDataServiceDeleteDataResult{}
}

var TDataServiceDeleteDataResult_Success_DEFAULT TErrorCode
func (p *TDataServiceDeleteDataResult) GetSuccess() TErrorCode {
  if !p.IsSetSuccess() {
    return TDataServiceDeleteDataResult_Success_DEFAULT
  }
return *p.Success
}
func (p *TDataServiceDeleteDataResult) IsSetSuccess() bool {
  return p.Success != nil
}

func (p *TDataServiceDeleteDataResult) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *TDataServiceDeleteDataResult)  ReadField0(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(); err != nil {
  return thrift.PrependError("error reading field 0: ", err)
} else {
  temp := TErrorCode(v)
...
func (p *TDataServiceDeleteDataResult) Write(oprot thrift.TProtocol) error {
...
func (p *TDataServiceDeleteDataResult) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
    if err := oprot.WriteFieldBegin("success", thrift.I32, 0); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err) }
    if err := oprot.WriteI32(int32(*p.Success)); err != nil {
...
func (p *TDataServiceDeleteDataResult) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("TDataServiceDeleteDataResult(%+v)", *p)
}


type StringMapKVService interface {
TDataService
}

type StringMapKVServiceClient struct {
  c thrift.TClient
  *TDataServiceClient
}

// Deprecated: Use NewStringMapKVService instead
func NewStringMapKVServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *StringMapKVServiceClient {
  return &StringMapKVServiceClient{TDataServiceClient: NewTDataServiceClientFactory(t, f)}}

// Deprecated: Use NewStringMapKVService instead
func NewStringMapKVServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *StringMapKVServiceClient {
  return &StringMapKVServiceClient{TDataServiceClient: NewTDataServiceClientProtocol(t, iprot, oprot)}
}

func NewStringMapKVServiceClient(c thrift.TClient) *StringMapKVServiceClient {
  return &StringMapKVServiceClient{
    c: c,
    TDataServiceClient: NewTDataServiceClient(c),
  }
}

type StringMapKVServiceProcessor struct {
  *TDataServiceProcessor
}

func NewStringMapKVServiceProcessor(handler StringMapKVService) *StringMapKVServiceProcessor {
  self22 := &StringMapKVServiceProcessor{NewTDataServiceProcessor(handler)}
  return self22
}
