...
class TPostItem : public virtual ::apache::thrift::TBase {
 public:
  ...
  TPostItem() : idpost(0), uid(0), content(), idbackground(), idfeeling(), privacy(0), locationId(), timestamps(0), pubkey(), topubkey(), touid(0), togroupid(0) {
  }
