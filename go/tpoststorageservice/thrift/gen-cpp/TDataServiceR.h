...
class TDataServiceRIfSingletonFactory : virtual public TDataServiceRIfFactory {
 public:
  TDataServiceRIfSingletonFactory(const ::std::shared_ptr<TDataServiceRIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::std::shared_ptr<TDataServiceRIf> iface_;
};
...
class TDataServiceR_getData_args {
 public:
  ...
  virtual ~TDataServiceR_getData_args() noexcept;
  TKey key;
...
class TDataServiceR_getData_pargs {
 public:
  ...
  virtual ~TDataServiceR_getData_pargs() noexcept;
  const TKey* key;
...
class TDataServiceR_getData_result {
 public:
  ...
  virtual ~TDataServiceR_getData_result() noexcept;
  TDataResult success;
...
class TDataServiceR_getData_presult {
 public:
  ...
  virtual ~TDataServiceR_getData_presult() noexcept;
  TDataResult* success;
...
class TDataServiceRClient : virtual public TDataServiceRIf {
 public:
  TDataServiceRClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  TDataServiceRClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class TDataServiceRProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  TDataServiceRProcessor(::std::shared_ptr<TDataServiceRIf> iface) :
    iface_(iface) {
...
class TDataServiceRProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  TDataServiceRProcessorFactory(const ::std::shared_ptr< TDataServiceRIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::std::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::std::shared_ptr< TDataServiceRIfFactory > handlerFactory_;
};

class TDataServiceRMultiface : virtual public TDataServiceRIf {
 public:
  TDataServiceRMultiface(std::vector<std::shared_ptr<TDataServiceRIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~TDataServiceRMultiface() {}
 protected:
  std::vector<std::shared_ptr<TDataServiceRIf> > ifaces_;
  TDataServiceRMultiface() {}
  void add(::std::shared_ptr<TDataServiceRIf> iface) {
...
class TDataServiceRConcurrentClient : virtual public TDataServiceRIf {
 public:
  TDataServiceRConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(prot);
  }
  TDataServiceRConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(iprot,oprot);
  }
 private:
