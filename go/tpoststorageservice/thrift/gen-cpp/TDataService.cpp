...
TDataService_getData_pargs::~TDataService_getData_pargs() noexcept {
}
...
TDataService_getData_result::~TDataService_getData_result() noexcept {
}
...
TDataService_getData_presult::~TDataService_getData_presult() noexcept {
}
...
TDataService_putData_args::~TDataService_putData_args() noexcept {
}
...
TDataService_putData_pargs::~TDataService_putData_pargs() noexcept {
}
...
TDataService_putData_result::~TDataService_putData_result() noexcept {
}
...
TDataService_putData_presult::~TDataService_putData_presult() noexcept {
}
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          (*(this->success)) = (TErrorCode::type)ecast39;
          this->__isset.success = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
TDataService_removeData_args::~TDataService_removeData_args() noexcept {
}
...
TDataService_removeData_pargs::~TDataService_removeData_pargs() noexcept {
}
...
TDataService_removeData_result::~TDataService_removeData_result() noexcept {
}
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->success = (TErrorCode::type)ecast40;
          this->__isset.success = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
TDataService_removeData_presult::~TDataService_removeData_presult() noexcept {
}
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          (*(this->success)) = (TErrorCode::type)ecast41;
          this->__isset.success = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->listkey.resize(_size42);
            uint32_t _i46;
            for (_i46 = 0; _i46 < _size42; ++_i46)
            {
              xfer += iprot->readI64(this->listkey[_i46]);
            }
...
uint32_t TDataService_getListDatas_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("listkey", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector<TKey> ::const_iterator _iter47;
    for (_iter47 = this->listkey.begin(); _iter47 != this->listkey.end(); ++_iter47)
    {
...
uint32_t TDataService_getListDatas_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_I64, static_cast<uint32_t>((*(this->listkey)).size()));
    std::vector<TKey> ::const_iterator _iter48;
    for (_iter48 = (*(this->listkey)).begin(); _iter48 != (*(this->listkey)).end(); ++_iter48)
    {
